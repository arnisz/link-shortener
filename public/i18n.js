const TRANSLATIONS = {
  en: {
    ...
    'app.create.tags.placeholder':      'Enter tag…',
  ...
  de: {
    ...
    'app.create.tags':                 'Tags (optional, max. 10)',
    'app.create.tags.placeholder':      'Tag eingeben…',
  ...
  es: {
    ...
    'app.create.tags.placeholder':      'Introduce etiqueta…',
  ...
  fr: {
    ...
    'app.create.tags.placeholder':      'Entrer un tag…',
