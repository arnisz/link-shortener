const TRANSLATIONS = {
  en: {
    ...
    'app.create.alias.title':          '3–50 characters: letters (a–z, A–Z), digits, hyphen (-), underscore (_)',
  ...
  de: {
    ...
    'app.create.alias.title':          '3–50 Zeichen: Buchstaben (a–z, A–Z), Ziffern, Bindestrich (-), Unterstrich (_)',
  ...
  es: {
    ...
    'app.create.alias.title':          '3–50 caracteres: letras (a–z, A–Z), dígitos, guión (-), guión bajo (_)',
  ...
  fr: {
    ...
    'app.create.alias.title':          '3–50 caractères : lettres (a–z, A–Z), chiffres, tiret (-), underscore (_)',
