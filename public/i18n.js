const TRANSLATIONS = {
  en: {
    ...
    'report.link':         'Report suspicious link',
    'report.page.title':   'Report abusive link – aadd.li',
    'report.page.description': 'Report suspicious or abusive links on aadd.li. Submit either a short URL or a destination URL and we will review it.',
    'report.back':         '← Back to home',
    'report.title':        'Report abusive link',
    'report.intro':        'If an aadd.li link or destination URL looks suspicious to you, you can report it here manually. We review every submission and combine it with other signals.',
    'report.notice.title': 'Important note',
    'report.notice.body':  'Please only report links you genuinely suspect of phishing, malware, fraud, or other abuse. The confirmation stays intentionally neutral and does not reveal whether a link exists.',
    'report.url.label':    'Short URL or destination URL',
    'report.url.placeholder': 'https://aadd.li/r/abc123',
    'report.url.aria':     'URL to report',
    'report.url.help':     'You can submit either the aadd.li short URL or the full destination URL.',
    'report.note.label':   'Free text (optional)',
    'report.note.placeholder': 'Why does this link look suspicious?',
    'report.note.help':    'For example: phishing page, fake login, malware download, or misleading redirect.',
    'report.turnstile.help': 'A short bot check is required to protect the form from abuse.',
    'report.submit':       'Send report',
    'report.success':      'Thanks, your report was received and will be reviewed.',
    'report.error.turnstile': 'Please complete the bot check before sending the report.',
    'report.error.flood':  'Too many reports from this network. Please try again in 10 minutes.',
    'report.error.invalid': 'Your report could not be processed. Please check the input and try again.',
    'report.error.generic': 'Your report could not be sent. Please try again later.',
    'report.error.network': 'Network error while sending the report. Please try again.',
    ...
    'app.create.tags':                 'Tags (optional, max 10)',
    'app.create.tags.placeholder':      'Tag, Space or Enter…',
    'app.search.placeholder':          'Search links, tags…',
  ...
  de: {
    ...
    'report.link':         'Verdächtigen Link melden',
    'report.page.title':   'Missbräuchlichen Link melden – aadd.li',
    'report.page.description': 'Melde verdächtige oder missbräuchliche Links an aadd.li. Gib Kurz-URL oder Ziel-URL an und wir prüfen den Fall.',
    'report.back':         '← Zurück zur Startseite',
    'report.title':        'Missbräuchlichen Link melden',
    'report.intro':        'Wenn dir ein aadd.li-Link oder eine Ziel-URL verdächtig vorkommt, kannst du sie hier manuell melden. Wir prüfen jede Meldung und werten sie zusammen mit weiteren Signalen aus.',
    'report.notice.title': 'Wichtiger Hinweis',
    'report.notice.body':  'Bitte melde nur Links, die du tatsächlich für Phishing, Malware, Betrug oder anderen Missbrauch hältst. Die Bestätigung bleibt absichtlich neutral und verrät nicht, ob ein Link existiert.',
    'report.url.label':    'Kurz-URL oder Ziel-URL',
    'report.url.placeholder': 'https://aadd.li/r/abc123',
    'report.url.aria':     'Zu meldende URL',
    'report.url.help':     'Du kannst entweder die aadd.li-Kurz-URL oder die vollständige Ziel-URL eintragen.',
    'report.note.label':   'Freitext (optional)',
    'report.note.placeholder': 'Was macht den Link verdächtig?',
    'report.note.help':    'Zum Beispiel: Phishing-Seite, gefälschter Login, Malware-Download oder irreführende Weiterleitung.',
    'report.turnstile.help': 'Zum Schutz vor Formular-Missbrauch ist eine kurze Bot-Prüfung erforderlich.',
    'report.submit':       'Meldung senden',
    'report.success':      'Danke, deine Meldung wurde entgegengenommen und wird geprüft.',
    'report.error.turnstile': 'Bitte schließe die Bot-Prüfung ab, bevor du die Meldung sendest.',
    'report.error.flood':  'Zu viele Meldungen aus diesem Netz. Bitte versuche es in 10 Minuten erneut.',
    'report.error.invalid': 'Deine Meldung konnte nicht verarbeitet werden. Bitte prüfe die Eingabe und versuche es erneut.',
    'report.error.generic': 'Deine Meldung konnte nicht gesendet werden. Bitte versuche es später erneut.',
    'report.error.network': 'Netzwerkfehler beim Senden der Meldung. Bitte versuche es erneut.',
    ...
    'app.create.tags':                 'Tags (optional, max. 10)',
    'app.create.tags.placeholder':      'Tag, Komma oder Enter…',
    'app.search.placeholder':          'Suche Links, Tags…',
  ...
  es: {
    ...
    'report.link':         'Reportar enlace sospechoso',
    'report.page.title':   'Reportar enlace abusivo – aadd.li',
    'report.page.description': 'Reporta enlaces sospechosos o abusivos en aadd.li. Envía una URL corta o una URL de destino y la revisaremos.',
    'report.back':         '← Volver al inicio',
    'report.title':        'Reportar enlace abusivo',
    'report.intro':        'Si un enlace de aadd.li o una URL de destino te parece sospechoso, puedes reportarlo aquí manualmente. Revisamos cada envío y lo combinamos con otras señales.',
    'report.notice.title': 'Aviso importante',
    'report.notice.body':  'Reporta solo enlaces que realmente sospeches de phishing, malware, fraude u otro abuso. La confirmación es intencionalmente neutral y no revela si un enlace existe.',
    'report.url.label':    'URL corta o URL de destino',
    'report.url.placeholder': 'https://aadd.li/r/abc123',
    'report.url.aria':     'URL a reportar',
    'report.url.help':     'Puedes enviar la URL corta de aadd.li o la URL completa de destino.',
    'report.note.label':   'Texto libre (opcional)',
    'report.note.placeholder': '¿Por qué te parece sospechoso este enlace?',
    'report.note.help':    'Por ejemplo: página de phishing, inicio de sesión falso, descarga de malware o redirección engañosa.',
    'report.turnstile.help': 'Se requiere una breve comprobación anti-bots para proteger el formulario del abuso.',
    'report.submit':       'Enviar reporte',
    'report.success':      'Gracias, tu reporte fue recibido y será revisado.',
    'report.error.turnstile': 'Completa la verificación anti-bots antes de enviar el reporte.',
    'report.error.flood':  'Demasiados reportes desde esta red. Inténtalo de nuevo en 10 minutos.',
    'report.error.invalid': 'Tu reporte no pudo procesarse. Revisa la entrada e inténtalo de nuevo.',
    'report.error.generic': 'Tu reporte no pudo enviarse. Inténtalo de nuevo más tarde.',
    'report.error.network': 'Error de red al enviar el reporte. Inténtalo de nuevo.',
    ...
    'app.create.tags':                 'Etiquetas (opcional, máx. 10)',
    'app.create.tags.placeholder':      'Etiqueta, coma o Enter…',
    'app.search.placeholder':          'Buscar enlaces, etiquetas…',
  ...
  fr: {
    ...
    'report.link':         'Signaler un lien suspect',
    'report.page.title':   'Signaler un lien abusif – aadd.li',
    'report.page.description': 'Signalez des liens suspects ou abusifs sur aadd.li. Envoyez soit une URL courte soit une URL de destination et nous examinerons le cas.',
    'report.back':         '← Retour à l’accueil',
    'report.title':        'Signaler un lien abusif',
    'report.intro':        'Si un lien aadd.li ou une URL de destination vous paraît suspect, vous pouvez le signaler ici manuellement. Nous examinons chaque signalement et le recoupons avec d’autres signaux.',
    'report.notice.title': 'Note importante',
    'report.notice.body':  'Veuillez signaler uniquement les liens que vous suspectez réellement de phishing, malware, fraude ou autre abus. La confirmation reste volontairement neutre et ne révèle pas si un lien existe.',
    'report.url.label':    'URL courte ou URL de destination',
    'report.url.placeholder': 'https://aadd.li/r/abc123',
    'report.url.aria':     'URL à signaler',
    'report.url.help':     'Vous pouvez envoyer soit l’URL courte aadd.li, soit l’URL complète de destination.',
    'report.note.label':   'Texte libre (facultatif)',
    'report.note.placeholder': 'Pourquoi ce lien vous semble-t-il suspect ?',
    'report.note.help':    'Par exemple : page de phishing, faux écran de connexion, téléchargement de malware ou redirection trompeuse.',
    'report.turnstile.help': 'Une courte vérification anti-bot est requise pour protéger le formulaire contre les abus.',
    'report.submit':       'Envoyer le signalement',
    'report.success':      'Merci, votre signalement a été reçu et sera examiné.',
    'report.error.turnstile': 'Veuillez terminer la vérification anti-bot avant d’envoyer le signalement.',
    'report.error.flood':  'Trop de signalements depuis ce réseau. Veuillez réessayer dans 10 minutes.',
    'report.error.invalid': 'Votre signalement n’a pas pu être traité. Vérifiez la saisie puis réessayez.',
    'report.error.generic': 'Votre signalement n’a pas pu être envoyé. Veuillez réessayer plus tard.',
    'report.error.network': 'Erreur réseau lors de l’envoi du signalement. Veuillez réessayer.',
    ...
    'app.create.tags':                 'Tags (facultatif, max 10)',
    'app.create.tags.placeholder':      'Tag, virgule ou Entrée…',
    'app.search.placeholder':          'Chercher liens, tags…',
